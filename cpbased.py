...
<constraints_placeholder>
    ...
    def get_opl_model_penalty(self, job_tuples, number_of_boards):
    ...
    def solve_penalty_only(self, jobs_data, number_of_boards):
        opl_model = self.get_opl_model_penalty(jobs_data, number_of_boards)
